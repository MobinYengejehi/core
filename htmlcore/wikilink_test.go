...
func TestGoDocWikilink(t *testing.T) {
	h := GoDocWikilink("doc", "github.com/MobinYengejehi/core")
	url, label := h("doc:htmlcore")
	assert.Equal(t, "https://pkg.go.dev/github.com/MobinYengejehi/core/htmlcore", url)
	assert.Equal(t, "htmlcore", label)
	url, label = h("doc:core.Button")
	assert.Equal(t, "https://pkg.go.dev/github.com/MobinYengejehi/core/core#Button", url)
	assert.Equal(t, "core.Button", label)
	url, label = h("doc:core.Button.Text")
	assert.Equal(t, "https://pkg.go.dev/github.com/MobinYengejehi/core/core#Button.Text", url)
