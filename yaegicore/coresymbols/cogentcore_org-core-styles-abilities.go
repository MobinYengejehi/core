// Code generated by 'yaegi extract github.com/MobinYengejehi/core/styles/abilities'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/MobinYengejehi/core/styles/abilities/abilities"] = map[string]reflect.Value{
