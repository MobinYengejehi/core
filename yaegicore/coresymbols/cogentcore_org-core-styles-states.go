// Code generated by 'yaegi extract github.com/MobinYengejehi/core/styles/states'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/MobinYengejehi/core/styles/states/states"] = map[string]reflect.Value{
