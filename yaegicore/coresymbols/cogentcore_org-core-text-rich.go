// Code generated by 'yaegi extract github.com/MobinYengejehi/core/text/rich'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/MobinYengejehi/core/text/rich/rich"] = map[string]reflect.Value{
