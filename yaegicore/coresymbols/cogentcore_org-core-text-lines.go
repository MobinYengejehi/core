// Code generated by 'yaegi extract github.com/MobinYengejehi/core/text/lines'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/MobinYengejehi/core/text/lines/lines"] = map[string]reflect.Value{
