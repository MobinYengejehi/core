// Code generated by 'yaegi extract github.com/MobinYengejehi/core/colors'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/MobinYengejehi/core/colors/colors"] = map[string]reflect.Value{
