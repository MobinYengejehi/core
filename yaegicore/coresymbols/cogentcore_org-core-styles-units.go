// Code generated by 'yaegi extract github.com/MobinYengejehi/core/styles/units'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/MobinYengejehi/core/styles/units/units"] = map[string]reflect.Value{
