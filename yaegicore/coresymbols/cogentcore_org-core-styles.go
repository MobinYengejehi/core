// Code generated by 'yaegi extract github.com/MobinYengejehi/core/styles'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/MobinYengejehi/core/styles/styles"] = map[string]reflect.Value{
