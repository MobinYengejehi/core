// Code generated by 'yaegi extract github.com/MobinYengejehi/core/base/errors'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/MobinYengejehi/core/base/errors/errors"] = map[string]reflect.Value{
