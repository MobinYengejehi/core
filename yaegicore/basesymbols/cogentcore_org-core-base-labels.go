// Code generated by 'yaegi extract github.com/MobinYengejehi/core/base/labels'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/MobinYengejehi/core/base/labels/labels"] = map[string]reflect.Value{
