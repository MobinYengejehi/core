...
var _ = types.AddType(&types.Type{Name: "github.com/MobinYengejehi/core/xyz.TextureFile", IDName: "texture-file", Doc: "TextureFile is a texture loaded from a file", Embeds: []types.Field{{Name: "TextureBase"}}, Fields: []types.Field{{Name: "FS", Doc: "filesystem for embedded etc"}, {Name: "File", Doc: "filename for the texture"}}})

var _ = types.AddType(&types.Type{Name: "github.com/MobinYengejehi/core/xyz.TextureCore", IDName: "texture-core", Doc: "TextureCore is a dynamic texture material driven by a core.Scene.\nAnything rendered to the scene will be projected onto the surface of any\nsolid using this texture. TODO: update this along with embed2d", Embeds: []types.Field{{Name: "TextureBase"}}})
